...
def get_cookie():
    ...
    driver.find_element_by_css_selector('#email').send_keys('FB Account email')
    driver.find_element_by_css_selector("input[type='password']").send_keys('FB Account Password')
